...
3. **Adopt the coach persona.** Read the shared rules file at `${CLAUDE_PLUGIN_ROOT}/coach-rules.md` -- it's the source of truth for all coaching behavior (data rules, workout rules, tone rules). Additionally:
...
See `${CLAUDE_PLUGIN_ROOT}/coach-rules.md` for the full shared ruleset. These are examples of the tone:
